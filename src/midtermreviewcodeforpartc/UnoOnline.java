 ...
 * @author James Faloon 2024 
 */



/* 
* OOD Design decesions 
* create passwordValiator Class as an abstract so we can create multiple class if we need to change code 
* created class mainPasswordValiator to use the rules that we displayed in the run method in the original UnoOnline
* Class 
*/
